...
function addTodo() {
    ...
    const todoObject = generateTodoObject(generatedID, textTodo, Number(year), name, checkboxValue);
...
function generateTodoObject(id, title, year, name, isCompleted) {
    return {
        id,
        title,
        year,
...
function makeTodo(todoObject) {
    ...
    name.innerText = 'Penulis/Penerbit : ' + todoObject.name;
    name.style.fontWeight = 'normal';

    const textyear = document.createElement('p');
    textyear.innerText = 'Tahun Terbit : ' + todoObject.year;

    const textContainer = document.createElement('div');
    textContainer.classList.add('inner');
    textContainer.append(textTitle, name, textyear);
    ...
    if (todoObject.isCompleted) {
        ...
        iconContainer.append(undoButton, trashButton);
        ...
        const iconContainer = document.createElement('div');
        iconContainer.classList.add('iconContainer')
        iconContainer.append(checkButton, trashButton);
